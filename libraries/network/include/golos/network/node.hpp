...
namespace golos {
    namespace network {
        ...
        public:
             ...
             */
            virtual bool handle_block(const golos::network::block_message &blk_msg, bool sync_mode,
             ...
             *          safe to broadcast on.
             */
            virtual void handle_transaction(const golos::network::trx_message &trx_msg) = 0;
