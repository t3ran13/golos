...
// TROUBLE
    ...
    BOOST_AUTO_TEST_CASE(golos_plugins_follow_follow_api_object) {
        try {
            ...
            set_random_value(v1.follower);
            set_random_value(v1.following);
            // set_random_value(v1.what); // AKA std::vector<follow_type> where follow_type == enum. TODO 
...
// TODO:        EASY TO TEST, BUT THIS CODE IS IN CPP FILE....
...
//  node_configuration is in .CPP FILE
